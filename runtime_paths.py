...
RAW_CACHE_FILES = {"historical_replay_1m_60d.csv","historical_replay_5m_180d.csv","historical_replay_15m_365d.csv","historical_replay_1h_3y.csv","historical_replay_15m_90d.csv","historical_replay_1h_365d.csv","historical_replay_1d_2y.csv","historical_shadow_replay.csv","micro_history.csv","macro_day.csv","macro_week.csv","macro_levels.csv","market.csv","trade_outcomes.csv","feature_store_summary.csv"}
...
RUNTIME_FILES = {"calculation_status.json","calculation_complete_latch.json","viewer_snapshot.json","historical_replay_manifest.json","startup_runtime_inventory.csv","post_patch_audit.csv","exchange_product_map.csv","products_active.csv","products_selected.json","fixed_intersection_backlog_status.json"}
RESEARCH_FILES = {
