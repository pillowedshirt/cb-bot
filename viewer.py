...
def render_live_dashboard() -> None:
    ...
    level8_tables = [
        ("Level 8 council decisions", council_decisions, [
            "dt_utc", "dt_mst", "product_id", "action", "strategy", "bucket", "risk_mode",
            "truth_score", "final_buy_score", "buy_threshold",
            "final_sell_score", "sell_threshold",
            "recommended_position_pct", "confidence", "reason",
        ], "No council decisions yet.", 300),
        ("Level 8 agent votes", council_votes, [
            "dt_utc", "dt_mst", "product_id", "agent", "strategy",
            "setup_tag", "market_regime", "execution_state", "learning_score",
            "raw_buy_score", "adjusted_buy_score",
            "raw_sell_score", "adjusted_sell_score",
            "raw_hold_score", "adjusted_hold_score",
            "raw_wait_score", "adjusted_wait_score",
            "confidence", "reliability", "weight",
            "leaderboard_rank", "leaderboard_score", "leader_bonus", "leader_penalty",
            "product_adjustment", "strategy_adjustment",
            "recent_performance_adjustment", "reason",
        ...
        ("Level 8 agent adjustments", agent_adjustments, [
            "dt_utc", "agent", "product_id", "strategy",
        ...
        ("Adaptive thresholds", adaptive_thresholds, [
            "dt_utc", "scope", "product_id", "strategy",
        ...
        ("Agent leaderboard", agent_leaderboard, [
            "dt_utc", "agent", "leaderboard_rank", "leaderboard_score",
            "weighted_credit", "recent_credit", "sample_size",
            "leader_bonus", "leader_penalty", "reason",
        ], "No agent leaderboard rows yet.", 500),
        ("Sell outcomes", sell_outcomes, [
            "dt_mst", "product_id", "decision_action", "review_minutes",
            "sell_price", "review_price", "move_after_sell_bps",
            "sell_outcome_kind", "reason",
        ], "No sell outcome rows yet.", 500),
    ]
